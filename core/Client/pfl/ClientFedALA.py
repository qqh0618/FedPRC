...
class ClientFedALA(Client):
    ...
    def update_weights(self, global_round):   # 训练模型
        ...
        # ===============================
        # FedALA
        cALA = ALA(self.idx, self.ce, self.trainloader.dataset.datas, self.args.batch_size,
                   80, 2, 1.0, self.device)
        global_model = copy.deepcopy(self.model)
        cALA.adaptive_local_aggregation(global_model, self.model)
        # ===============================
