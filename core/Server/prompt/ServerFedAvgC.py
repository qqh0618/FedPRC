...
from core.Client.prompt.ClientFedAvgC import ClientFedAvgC
...
class ServerFedAvgC(Server):
    ...
    def Create_Clints(self):
        for idx in range(self.args.num_clients):
            self.LocalModels.append(
                ClientFedAvgC(self.args, copy.deepcopy(self.global_model), self.net_idx_dataidx_map[idx], idx=idx,
    ...
    def train(self):
        ...
        for epoch in tqdm(range(self.args.comm_round)):
            ...
            print(f"全局测试耗时:",time.time()-start_time)
