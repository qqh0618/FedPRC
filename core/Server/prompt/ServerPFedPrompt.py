...
from core.Client.prompt.ClientPFedPrompt import ClientPFedPrompt
    ...
    def Create_Clints(self):
        for idx in range(self.args.num_clients):
            self.LocalModels.append(
                ClientPFedPrompt(self.args, copy.deepcopy(self.global_model), self.net_idx_dataidx_map[idx], idx=idx,
