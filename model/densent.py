...
class DenseNet(nn.Module):
    ...
    def __init__(
        ...
        self.line_squeeze = nn.Linear(num_features, num_features//4)
        self.v_head = nn.Linear(num_features//4, num_classes)
    ...
    def forward(self, x: Tensor, ns=None) -> Tensor:
        ...
        out2 = torch.flatten(out, 1)
        out = self.classifier(out2)
        # feats = self.line_squeeze(out2)
